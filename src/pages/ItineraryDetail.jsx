...
const destinationMeta = {
  ...
  maharashtra:   { img: '/assets/Maharashtra.jpg',        region: 'West India',      from: '/domestic',         fromLabel: 'Domestic' },
  gujarat:       { img: '/assets/Gujrat.jpg',        region: 'West India',      from: '/domestic',         fromLabel: 'Domestic' },
  tamilnadu:     { img: '/assets/temple-south-CC6aHc0Q.jpg',     region: 'South India',     from: '/domestic',         fromLabel: 'Domestic' },
  andhrapradesh: { img: '/assets/Andhra.jpg',     region: 'South India',     from: '/domestic',         fromLabel: 'Domestic' },
