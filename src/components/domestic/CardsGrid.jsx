          ...
          >
            ...
            >
              ...
              <div className="p-6 flex flex-col flex-grow">
                ...
                {/* Use line-clamp-3 to keep grid uniform */}
            ...
            >
              ...
              <div className="w-full md:w-1/2 p-8 md:p-12 flex flex-col overflow-y-auto">
                ...
                <a 
                  ...
                  target="_blank" 
                  rel="noreferrer" 
                  className="rounded-sm bg-primary text-white px-8 py-4 text-center text-[0.72rem] uppercase tracking-[0.22em] transition-colors hover:bg-[#003525]"
                >
